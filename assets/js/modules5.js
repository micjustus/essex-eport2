  ...
  units: [
    {
      ...
      activities: [
        {
          title: "Discussion 1: Project Failures",
...

    {
      ...
      activities: [
        {
          title:
            "Discussion 2: Factors Affecting User Experience",
...

    {
      ...
      activities: [
        {
          title:
            "Discussion 2: Factors Affecting User Experience (Responses)",
          href: "../assets/artefacts/module5/M5-Discussion_2_Responses.pdf",
          ref: "pdf",
          type: "discussion",
        },
        {
          title: "Activity: Components of User Experience",
...

    {
      ...
      activities: [
        {
          title:
            "Discussion 2: Factors Affecting User Experience (Summary)",
          href: "../assets/artefacts/module5/M5-Discussion_2_Summary.pdf",
          ref: "pdf",
          type: "discussion",
        },
        {
...

    {
      ...
      activities: [
        {
          title: "Activity: Improve Code Quality",
          href: "../assets/artefacts/module5/M5-Activity_3_ImprovingCodeQuality.pdf",
          ref: "pdf",
          type: "activity",
        },
        {
...

    {
      ...
      activities: [
        {
          title: "Codio Activity: Improve Code Quality with Linters",
